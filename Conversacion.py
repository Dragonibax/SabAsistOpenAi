...
import os
from Funciones import gather_user_data,gather_medical_reason, gather_reservation_data, not_talk
###################################################
...
assistant = client.beta.assistants.retrieve("asst_yznNYXXXXXXXXXXXX");
###################################################
# 5. Conversacion
stop= True;
    ...
    if run.status == "requires_action":
        ...
        for each_tool in tools_to_calls:
            ...
            if function_name =="gather_user_data":
                ...
                output= "Ahora pregunta sobre el motivo medico por el que agenda la cita"
            elif function_name == "gather_medical_reason":
                output = "Ahora pregunta sobre los detalles del horario de la cita";
